<nav class="bg-gradient-to-r from-green-100 to-green-200 shadow-md">
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="font-bold text-lg bg-gradient-to-r from-green-500 to-blue-500 bg-clip-text text-transparent">
                    econscious
                </span>
            </div>

            <!-- MENU -->
            <div class="hidden sm:flex gap-8 text-green-800 font-medium">
            ...
            <div class="relative">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="bg-gradient-to-r from-green-400 to-blue-400 text-white px-4 py-2 rounded-full shadow-md flex items-center gap-2 hover:scale-105 transition">
                            {{ Auth::user()->name }}
