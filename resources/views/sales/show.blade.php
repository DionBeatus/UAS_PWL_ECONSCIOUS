                ...
                <div class="mb-6 bg-white/50 backdrop-blur-sm p-4 rounded-xl border border-green-100 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <span class="text-base font-semibold text-gray-800">{{ $sale->customer_name }}</span>
                        </div>
                        <div>
                        ...
                        <div class="mt-1">
                            <span class="block text-gray-500 font-medium">Waktu Pencatatan:</span>
                            <span class="text-base font-semibold text-gray-800">{{ $sale->created_at->format('d M Y, H:i') }} WIB</span>
                        </div>
                    </div>
                </div>
