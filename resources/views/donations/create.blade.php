            ...
            <div class="bg-blue-100 shadow-sm sm:rounded-lg p-6 bg-gradient-to-b from-white to-[#CDFFC7]">
                ...
                <form action="{{ route('donations.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="donor_name" value="{{ old('donor_name') }}" class="w-full border rounded px-3 py-2 bg-white focus:ring-green-500 focus:border-green-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <input type="date" name="donation_date" value="{{ old('donation_date', date('Y-m-d')) }}" class="w-full border rounded px-3 py-2 bg-white focus:ring-green-500 focus:border-green-500">
                    ...
                    <div class="mb-6">
                        ...
                        <div id="product-container" class="space-y-3">
                            ...
                            <div class="flex flex-wrap md:flex-nowrap gap-2 items-center bg-white p-3 rounded-lg border border-green-100 product-row">
                                ...
                                <div class="pt-5">
                                    <button type="button" class="px-3 py-2 bg-red-500 font-semibold text-white rounded hover:bg-red-600 text-sm remove-row">
                                        Hapus
                                    </button>
                                </div>
                            </div>
                        </div>
                        <button type="button" id="add-product" class="mt-3 px-3 py-1.5 bg-blue-600 text-white rounded text-sm font-medium hover:bg-blue-700 transition">
                            + Tambah Produk
                        </button>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('donations.index') }}" class="px-4 py-2 bg-orange-500 text-white rounded hover:bg-orange-600 transition font-medium">
                            Kembali
                        </a>
